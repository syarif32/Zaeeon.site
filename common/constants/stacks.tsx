...
import { FaNpm, FaGolang, FaJava, FaMicrosoft, FaFileExcel, FaFileWord } from "react-icons/fa6";
...
export const STACKS: SkillProps = {
  ...
  "Agora RTC": {
    icon: <BsCameraVideoFill size={iconSize} />,
    background: "bg-sky-500",
    color: "text-sky-500",
    isActive: true,
  },
  "Web Speech API": {
    icon: <BsMicFill size={iconSize} />,
    background: "bg-purple-500",
    color: "text-purple-500",
    isActive: true,
  },
  "Microsoft Excel": {
    icon: <FaFileExcel size={iconSize} />,
    background: "bg-green-600",
    color: "text-green-600",
    isActive: true,
  },
  "Microsoft Word": {
    icon: <FaFileWord size={iconSize} />,
    background: "bg-blue-700",
    color: "text-blue-700",
    isActive: true,
  },
