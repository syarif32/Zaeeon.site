  <h1>Muhammad Najwa Syarif</h1>
  <p>🔥 Personal website was built originally from scratch using Next.js, TypeScript, Tailwind CSS, SWR, Supabase and more.</p> 

[(https://img.shields.io/github/stars/syarif32/PortofolioWebsite)](https://github.com/syarif32/PortofolioWebsite/stargazers)
...
Using `degit`:
```bash
npx degit YOUR_APP_NAME
```

Or deploy directly to Vercel / Netlify:

[![Deploy to Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https://github.com/syarif32/PortofolioWebsite)  
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/syarif32/PortofolioWebsite)
